...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    */
    'logo_mini'          => '<span class="text-warning">SO</span>span>',
    ...
    */
    ...
    |  Template settings
    |--------------------------------------------------------------------------
    | 'jquery' - Enabled/Disabled jQuery
    |
    | 'jqueryPath' - jQuery CDN link
    | - //cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.min.js
    | - //cdn.jsdelivr.net/npm/jquery@3.6.0/dist/jquery.slim.min.js
    |
    | 'colors' - Choose colors for customization template or leave blank.
    |
    */
