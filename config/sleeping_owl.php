...
return [
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    |  Allowed Extensions for uploaded images in wysiwyg field - array
    |--------------------------------------------------------------------------
    */
    ...
    /*
    |--------------------------------------------------------------------------
    |  use Original Name for Image Filename (if false - default -use  md5())
    |--------------------------------------------------------------------------
    */

    'imagesUseOriginalName' => false,
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    |  Allowed Extensions for uploaded files in wysiwyg field - array
    |--------------------------------------------------------------------------
    */

    'filesAllowedExtensions' => [], // ['pdf', 'doc', 'docx']

    /*
    |--------------------------------------------------------------------------
    |  use Original Name for File Filename (if false - default -use  md5())
    |--------------------------------------------------------------------------
    */

    'filesUseOriginalName' => false,
