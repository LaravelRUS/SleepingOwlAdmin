...
- Точка возобновления: переписать legacy filters module на native DOM; constructor boundary, актуальные options и регистрация DataTables extensions через активный engine уже завершены.
