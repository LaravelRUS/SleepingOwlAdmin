...
- Точка возобновления: проверить и зафиксировать config behavior таблиц (`state_datatables`, `state_filters`, request method, arbitrary options, highlight и autoupdate); table-scoped filter state уже завершён.
