...
- Точка возобновления: PHPDoc/public facades и существующие install/section stubs обновлены. Следующий отдельный пункт — новые extension generator stubs и их test-application contract.
