...
- Точка возобновления: обновить DataTables core/extensions до согласованной 2.x-линии и отделить engine registration от AdminLTE presentation adapter; публичный Vue 3 custom-island API и этап 4 завершены.
