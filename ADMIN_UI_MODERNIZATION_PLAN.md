...
- Точка возобновления: общий no-build theme extension contract закрыт; в новой чистой задаче начать раздел 1 [`ADMIN_ADMINLTE_THEME_PLAN.md`](ADMIN_ADMINLTE_THEME_PLAN.md) с фиксации версий, peer dependencies и license inventory AdminLTE 4/Bootstrap 5. Полноценную Tailwind-тему не начинать.
