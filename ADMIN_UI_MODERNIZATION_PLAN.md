...
- Точка возобновления: перевести actions и auto-update на прямой контракт `Admin.Tables.reload()` без jQuery/DataTables plugin lookup; draw hooks уже завершены.
