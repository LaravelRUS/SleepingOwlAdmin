...
- Точка возобновления: dependency/lock checkpoint раздела 1 [`ADMIN_ADMINLTE_THEME_PLAN.md`](ADMIN_ADMINLTE_THEME_PLAN.md) закрыт; в новой чистой задаче перевести DataTables presentation на Bootstrap 5 packages и удалить оставшиеся BS4 adapter artifacts, не начиная общий Blade migration или Tailwind-тему.
