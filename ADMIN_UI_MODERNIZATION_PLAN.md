...
- Точка возобновления: заменить Magnific Popup/lightbox на GLightbox; Select2/AJAX/dependent select уже переведены на Vue Multiselect 3, date/datetime/time/daterange — на единый Air Datepicker driver, X-editable — на native inline-editor controller, а Nestable tree — на SortableJS driver.
