...
- [ ] Реализовать современную `AdminLTETheme`, инкапсулирующую собственные Bootstrap/AdminLTE assets, markup и component adapters.
  ...
  - [ ] Сделать `feature:forms` и `feature:table` самозапускающимися browser entries и проверить реальные consumer scenarios без legacy aggregate.
