...
- Точка возобновления: version/dependency/license checkpoint раздела 1 [`ADMIN_ADMINLTE_THEME_PLAN.md`](ADMIN_ADMINLTE_THEME_PLAN.md) закрыт; в новой чистой задаче выполнить только dependency/lock checkpoint с exact pins `admin-lte@4.9.1`, `bootstrap@5.3.8`, `@popperjs/core@2.11.8`, удалением AdminLTE 3/Bootstrap 4/Popper 1 и без jQuery. DataTables, Blade, JS, Sass, assets и полноценную Tailwind-тему не начинать.
