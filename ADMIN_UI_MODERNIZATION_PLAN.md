...
- Точка возобновления: разделить filter state storage по таблицам и исключить коллизии на страницах с несколькими displays; native filter drivers и controls уже завершены.
