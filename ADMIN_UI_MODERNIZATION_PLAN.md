...
- Точка возобновления: перевести draw hooks (`Admin.Events`, tooltip, lazyload, highlight и inline editor) на native DOM/theme adapters; config behavior таблиц уже зафиксирован.
