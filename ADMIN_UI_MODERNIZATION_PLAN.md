...
- Точка возобновления: удалить DataTables presentation CSS из core и добавить отдельные presentation adapters для AdminLTE и Tailwind themes; actions и auto-update уже переведены на `Admin.Tables.reload()`.
