...
Tailwind на shadcn/ui ведётся в [`ADMIN_TAILWIND_THEME_PLAN.md`](ADMIN_TAILWIND_THEME_PLAN.md), третья встроенная тема на Tabler — в [`ADMIN_TABLER_THEME_PLAN.md`](ADMIN_TABLER_THEME_PLAN.md). Основной release checklist находится в [`ADMIN_UI_MODERNIZATION_PLAN.md`](ADMIN_UI_MODERNIZATION_PLAN.md).
...
| 2026-09-08 | Третья встроенная тема | Официальный Tabler Admin Template выбран основой `TablerTheme`; отдельная структура реализации и acceptance вынесены в `ADMIN_TABLER_THEME_PLAN.md`. |
