        ...
        @php
            $imagesProps = array_replace([
                ...
                'classes' => [
                    ...
                    'dialogCloseButton' => 'btn btn-light soa-images-dialog__close soa-icon-button',
                    ...
                    'gallery' => 'form-element-files dropzone clearfix soa-images__grid soa-attachment-list',
                    ...
                    'item' => 'form-element-files__item soa-images__item soa-attachment',
