...
return [
    ...
    'asset_health' => [
        'message' => 'Опубликованные ассеты админки (:published) не соответствуют установленной версии пакета (:installed).',
        'command' => 'Обновить ассеты:',
    ],
    ...
    'table' => [
        ...
        'destroy-confirm' => 'Вы уверены, что хотите навсегда удалить эту запись?',
    ...
    'image' => [
        ...
        'preview' => 'Просмотреть изображение',
    ...
    'button' => [
        ...
        'theme' => 'Сменить тему',
        'pause_auto_update' => 'Приостановить автообновление',
        'resume_auto_update' => 'Продолжить автообновление',
    ],
