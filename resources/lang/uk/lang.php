...
return [
    ...
    'asset_health' => [
        'message' => 'Опубліковані асети адмінки (:published) не відповідають установленій версії пакета (:installed).',
        'command' => 'Оновити асети:',
    ],
    ...
    'table' => [
        ...
        'destroy-confirm' => 'Ви впевнені, що хочете назавжди видалити цей запис?',
    ...
    'button' => [
        ...
        'theme' => 'Змінити тему',
        'pause_auto_update' => 'Призупинити автооновлення',
        'resume_auto_update' => 'Продовжити автооновлення',
    ],
