...
return [
    ...
    'message' => [
        'created' => '<i class="fas fa-check fa-lg"></i> Запис успішно створено',
        'updated' => '<i class="fas fa-check fa-lg"></i> Запис успішно обновлено',
        'deleted' => '<i class="fas fa-check fa-lg"></i> Запис успішно видалено',
        'restored' => '<i class="fas fa-check fa-lg"></i> Запис успішно відновлено',
