...
return [
    ...
    'message' => [
        'created' => '<i class="fas fa-check fa-lg"></i> Record has been created successfully',
        'updated' => '<i class="fas fa-check fa-lg"></i> Record has been updated successfully',
        'deleted' => '<i class="fas fa-check fa-lg"></i> Record has been deleted successfully',
        'destroyed' => '<i class="fas fa-check fa-lg"></i> Record has been destroyed successfully',
        'restored' => '<i class="fas fa-check fa-lg"></i> Record has been restored successfully',
