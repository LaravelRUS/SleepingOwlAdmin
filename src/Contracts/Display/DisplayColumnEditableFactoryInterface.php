 ...
 * @method Editable\Checklist checklist($name, $label = null, array|callable|Model|string $options = [], $small = null)
 ...
 * @method Editable\Select select($name, $label = null, array|callable|Model|string $options = [], $small = null)
