 ...
 * @method static \SleepingOwl\Admin\Display\Column\Editable\Checklist checklist($name, $label = null, array|callable|Model|string $options = [], $small = null)
 ...
 * @method static \SleepingOwl\Admin\Display\Column\Editable\Select select($name, $label = null, array|callable|Model|string $options = [], $small = null)
