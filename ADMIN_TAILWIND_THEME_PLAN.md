...
- Статус: **displays, DataTables 3 presentation и actions готовы; следующий checkpoint — forms, Vue island props, uploads, editors и related elements**.
...
- Следующий checkpoint: зеркалировать form logical views, собрать field/card/input/upload primitives и передать final Tailwind classes/options в существующие Vue islands только через Blade props.
