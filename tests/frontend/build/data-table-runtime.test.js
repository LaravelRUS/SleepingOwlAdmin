...
it('routes actions and auto-update through native modules and Admin.Tables', () => {
    ...
    expect(autoUpdate).toContain('this.tables.reload(this.table)')
    ...
    expect(autoUpdateView).toContain('data-admin-table-autoupdate-bar')
    expect(autoUpdateView).toContain('data-admin-table-autoupdate-toggle')
