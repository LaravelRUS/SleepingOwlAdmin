...
class TailwindThemeShellTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        config()->set([
            'sleeping_owl.body_default_class' => 'sidebar-mini sidebar-open project-body',
            ...
            'sleeping_owl.logo' => '<strong>Sleeping Owl</strong>',
            'sleeping_owl.logo_mini' => 'SO',
            'sleeping_owl.menu_top' => 'Operations',
