...
function createDataTableEngine(element, options) {
  return new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"](element, options);
}
function dataTableEngineRuntime() {
  return datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"];
}
function dataTableEngineVersions() {
  var _DataTable$Responsive;
  return Object.freeze({
    core: datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].version,
    responsive: (_DataTable$Responsive = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Responsive) === null || _DataTable$Responsive === void 0 ? void 0 : _DataTable$Responsive.version
  });
}
...
function createTableFilterDrivers(engine) {
  ...
  var searchExtensions = dataTableSearchExtensions(engine);
...
function dataTableSearchExtensions(engine) {
  var _engine$ext;
...
function formatRemovedOptionWarning(legacyName, migration) {
  return "[SleepingOwl Admin] DataTables 1 option \"".concat(legacyName, "\" ") + "is not supported by DataTables 3. ".concat(migration);
}
...
function applyServerOptions(options, definition) {
  var normalized = (0,_option_aliases_js__WEBPACK_IMPORTED_MODULE_0__.normalizeDataTableOptions)(options);
  if (!definition.url) {
    return normalized;
  }
...
function normalizeOptions(admin) {
  ...
  return {
    admin: admin,
    createEngine: (_options$createEngine = options.createEngine) !== null && _options$createEngine !== void 0 ? _options$createEngine : _engine_data_table_engine_js__WEBPACK_IMPORTED_MODULE_2__.createDataTableEngine,
    engine: (_options$engine = options.engine) !== null && _options$engine !== void 0 ? _options$engine : (0,_engine_data_table_engine_js__WEBPACK_IMPORTED_MODULE_2__.dataTableEngineRuntime)(),
...
var TABLE_CONTROLS_COMPONENT = 'table-controls';
var TABLE_CONTROLS_SELECTOR = 'body';
var LEGACY_MODULES = ['display.actions', 'display.actions_form', 'display.columns.checkbox', 'display.columns.control', 'display.columns.tree_control'];
function installTableControls(admin, options) {
  var definition = createTableControlsDefinition(admin, options);
  var scan = function scan() {
    var root = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : options.root;
    return admin.Components.scan(root, TABLE_CONTROLS_COMPONENT);
  };
  admin.Components.register(definition);
  LEGACY_MODULES.forEach(function (name) {
...
function createTableControlsDefinition(admin, options) {
  assertOptions(admin, options);
  return {
    mount: function mount(body) {
      return mountTableControls(body, admin, options);
    },
...
function mountTableControls(body, admin, options) {
  var callbacks = (0,_actions_named_action_callbacks_js__WEBPACK_IMPORTED_MODULE_2__.createNamedActionCallbacks)(options.target);
  var actions = actionDependencies(body, admin, options, callbacks);
  var unbind = [(0,_actions_bulk_actions_js__WEBPACK_IMPORTED_MODULE_0__.bindBulkActions)(actions), (0,_actions_form_actions_js__WEBPACK_IMPORTED_MODULE_1__.bindFormActions)(_objectSpread(_objectSpread({}, actions), {}, {
    FormData: options.FormData
  })), (0,_selection_checkbox_controls_js__WEBPACK_IMPORTED_MODULE_4__.bindTableCheckboxes)({
    root: body,
    selectedRowClass: 'info'
  }), (0,_controls_confirm_submit_js__WEBPACK_IMPORTED_MODULE_3__.bindConfirmedControls)(confirmedOptions(body, admin, options, 'table')), (0,_controls_confirm_submit_js__WEBPACK_IMPORTED_MODULE_3__.bindConfirmedControls)(confirmedOptions(body, admin, options, '.dd3-content'))];
  return function () {
    return unbind.reverse().forEach(function (remove) {
      return remove();
    });
  };
}
...
function hasAdminServices(admin) {
  var names = ['Components', 'Events', 'Http', 'Messages', 'Modules', 'Tables'];
  return names.every(function (name) {
    return Boolean(admin === null || admin === void 0 ? void 0 : admin[name]);
  });
}
function hasBrowserDependencies(options) {
  var names = ['FormData', 'location', 'questions', 'root', 'target'];
  var callbacks = ['notify', 'translate'];
  return names.every(function (name) {
    return Boolean(options === null || options === void 0 ? void 0 : options[name]);
  }) && callbacks.every(function (name) {
    return typeof (options === null || options === void 0 ? void 0 : options[name]) === 'function';
  });
}
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].util;
const childRow = function (row, update, render) {
    var rowNode = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(row.node());
    if (update) {
    ...
    return function (row, update, render, closeCallback) {
        ...
        if (!update) {
            ...
            var close = function () {
                ...
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).off('keypress.dtr');
            ...
            modal = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('div')
                ...
                .appendTo('body');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(row.node()).classAdd('dtr-expanded');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).on('keyup.dtr', function (e) {
                if (e.keyCode === 27) {
                    e.stopPropagation();
                    close();
                }
            ...
            modal = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('div.dtr-modal-content');
        ...
        if (options && options.header) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s('div.dtr-modal-content').prepend(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('h2').html(options.header(row)));
        }
        return true;
    };
}
        ...
        columns.forEach(function (col) {
            if (col.hidden) {
                col.className
                    ? 'class="' + col.className + '"'
                    : '';
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('li')
    ...
    return function (api, rowIdx, columns) {
        ...
        columns.forEach(function (col) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('li')
                ...
                .attr('data-dt-column', col.columnIndex)
                .append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('span').classAdd('dtr-title').html(col.title))
                .append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('span').classAdd('dtr-data').html(col.data))
                .appendTo(ul);
        });
...
function tableAll(options = {}) {
    options = datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].util.object.assign({
        tableClass: ''
    }, options);
    return function (api, rowIdx, columns) {
        ...
        columns.forEach(function (col) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('tr')
                .classAdd(col.className)
                .attr('data-dt-row', col.rowIndex)
                .attr('data-dt-column', col.columnIndex)
                .append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('td').html(col.title))
                .append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('td').html(col.data))
                .appendTo(table);
        });
...
// Sanity check
if (!datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"] || !datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].versionCheck || !datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].versionCheck('3')) {
...
class Responsive {
    ...
    constructor(dt, opts) {
        ...
        this.c = datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assignDeep({}, Responsive.defaults, datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.responsive, opts);
        this.s = {
            childNodeStore: {},
            columns: [],
            current: [],
            details: datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(this.c.details)
                ? datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.object.assign(details, this.c.details)
                : details,
            dt: new datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Api(dt),
            timer: null
        };
    ...
    _init() {
        var that = this;
        var dt = this.s.dt;
        var oldWindowWidth = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.width();
        // Use DataTables' throttle function to avoid processor thrashing
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.on('orientationchange.dtr', datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].util.throttle(function () {
            // iOS has a bug whereby resize can fire when only scrolling
            // See: http://stackoverflow.com/questions/8898412
            var width = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.width();
        ...
        dt.on('row-created.dtr', function (e, tr, data, idx) {
            if (that.s.current.includes(false)) {
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(tr)
                    .children('td, th')
                    .each(function (el, i) {
                    var idx = dt.column.index('toData', i);
                    if (that.s.current[idx] === false) {
                        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(el)
                            .css('display', 'none')
                            .classAdd('dtr-hidden');
                    }
                });
        ...
        dt.on('destroy.dtr', function () {
            dt.off('.dtr');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().body()).off('.dtr');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.w.off('resize.dtr orientationchange.dtr');
            dt.cells('.dtr-control').nodes().toDom().classRemove('dtr-control');
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).classRemove('dtr-inline collapsed');
        ...
        if (details.type !== false) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).classAdd('dtr-' + details.type);
        }
    ...
    _detailsDisplay(row, update) {
        ...
        var event = function (res) {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(row.node()).classToggle('dtr-expanded', res !== false);
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).trigger('responsive-display.dt', false, [
                dt,
                row,
                res,
                update
    ...
    _detailsInit() {
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().body()).on('keyup.dtr', 'td, th', function (e) {
            if (document.activeElement) {
                let activeNodeName = document.activeElement.nodeName.toLowerCase();
                if (e.keyCode === 13 &&
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).data('dtrKeyboard') &&
                    (activeNodeName === 'td' || activeNodeName === 'th')) {
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).trigger('click');
                }
            }
        });
        ...
        if (target !== undefined || target !== null) {
            ...
            // available
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().body()).on('click.dtr mousedown.dtr mouseup.dtr', selector, function (e) {
                // If the table is not collapsed (i.e. there is no hidden
                // columns) then take no action
                if (!datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).classHas('collapsed')) {
                    return;
                }
                ...
                if (!dt
                    ...
                    .nodes()
                    .toArray()
                    .includes(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).closest('tr').get(0))) {
                    return;
                }
                ...
                var row = dt.row(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).closest('tr'));
                ...
                if (e.type === 'click') {
                    ...
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).css('outline', 'none');
                }
                else if (e.type === 'mouseup') {
                    // And then re-allow at the end of the click
                    datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this).css('outline', '').trigger('blur');
                }
            });
        }
    }
    ...
    _resize(forceRedraw = false) {
        ...
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).classToggle('collapsed', collapsedClass);
        var changed = false;
        var visible = 0;
        var dtSettings = dt.settings()[0];
        var colGroup = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).children('colgroup');
        ...
        if (changed) {
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().node()).trigger('responsive-resize.dt', false, [
                dt,
                this._responsiveOnlyHidden()
            ]);
            // If no records, update the "No records" display element
            if (dt.page.info().recordsDisplay === 0) {
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(dt.table().body())
                    .find('td')
                    .eq(0)
    ...
    _resizeAuto() {
        ...
        dt.table()
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('tr').append(cells).appendTo(clonedHeader);
        });
        // Always need an empty row that we can read widths from
        var emptyRow = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('tr').appendTo(clonedBody);
        for (var i = 0; i < visibleColumns.count(); i++) {
            emptyRow.append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('td'));
        }
        // Body rows
        ...
        if (typeof renderer === 'function' && renderer._responsiveMovesNodes) {
            ...
            dt.rows({ page: 'current' }).every(function (rowIdx) {
                ...
                dt.cells(rowIdx, visibleColumns).every(function (rowIdx2, colIdx) {
                    ...
                    if (store) {
                        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this.node().cloneNode(false))
                            .append(datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(store).clone(true))
                            .appendTo(tr);
                    }
                    else {
                        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(this.node()).clone(true).appendTo(tr);
                    }
                });
        ...
        dt.table()
            ...
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.c('tr').append(cells).appendTo(clonedFooter);
        });
        // In the inline case extra padding is applied to the first column to
        // give space for the show / hide icon. We need to use this in the
        // calculation
        if (this.s.details.type === 'inline') {
            datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(clonedTable).classAdd('dtr-inline collapsed');
        }
        // It is unsafe to insert elements with the same name into the DOM
        // multiple times. For example, cloning and inserting a checked radio
        // clears the checked state of the original radio.
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(clonedTable).find('[name]').attrRemove('name');
    ...
    _setHeaderVis(col, showHide, structure) {
        ...
        structure.forEach(function (row) {
            if (row[col] && row[col].cell) {
                datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(row[col].cell)
                    .css('display', display)
                    .classToggle('dtr-hidden', !showHide);
            }
            else {
                ...
                while (search >= 0) {
                    if (row[search] && row[search].cell) {
                        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(row[search].cell).attr('colSpan', that._colspan(row, search));
                        break;
                    }
                    search--;
                }
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Api.register('responsive()', function () {
    return this.inst(this.context);
});
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Api.register('responsive.index()', function (li) {
    li = datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(li);
    return {
        column: li.data('dtr-index'),
        row: li.parent().data('dtr-index')
    };
});
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Api.register('responsive.rebuild()', function () {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Api.register('responsive.recalc()', function () {
    return this.iterator('table', function (ctx) {
        if (ctx._responsive) {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Api.register('responsive.hasHidden()', function () {
    var ctx = this.context[0];
    return ctx._responsive
        ? ctx._responsive._responsiveOnlyHidden().includes(false)
        : false;
});
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Api.registerPlural('columns().responsiveHidden()', 'column().responsiveHidden()', function () {
...
datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].Responsive = Responsive;
// Attach a listener to the document which listens for DataTables initialisation
// events so we can automatically initialise
datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(document).on('preInit.dt.dtr', function (e, settings, json) {
    if (e.namespace !== 'dt') {
        return;
    }
    if (datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(settings.table).classHas('responsive') ||
        datatables_net__WEBPACK_IMPORTED_MODULE_0__.Dom.s(settings.table).classHas('dt-responsive') ||
        settings.init.responsive ||
        datatables_net__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.responsive) {
        var init = settings.init.responsive;
        if (init !== false) {
            new Responsive(settings, datatables_net__WEBPACK_IMPORTED_MODULE_0__.util.is.plainObject(init) ? init : {});
        }
    }
});
...
function bootTables(target) {
  var admin = requireCompatibility(target.Admin);
  var options = (0,_browser_options_js__WEBPACK_IMPORTED_MODULE_3__.tableBrowserOptions)(target);
  var features = installFeatures(target, admin, options);
  var runtime = createTableRuntime(features, target.document);
...
function installFeatures(target, admin, options) {
  ...
  return {
    ...
    controls: (0,_runtime_install_table_controls_js__WEBPACK_IMPORTED_MODULE_6__.installTableControls)(admin, _objectSpread(_objectSpread(_objectSpread({}, options.actions), options.controls), {}, {
      root: root,
      target: target
    })),
    inlineEditor: inlineEditor,
...
function createTableRuntime(features, root) {
  return Object.freeze({
    ...
    scan: function scan() {
      ...
      return features.tables.scan(scanRoot) + features.inlineEditor.scan(scanRoot) + features.controls.scan(scanRoot) + features.autoUpdates.scan(scanRoot);
    },
    versions: (0,_engine_data_table_engine_js__WEBPACK_IMPORTED_MODULE_2__.dataTableEngineVersions)()
  });
}
function requireCompatibility(admin) {
  var required = ['Components', 'Config', 'Events', 'Http', 'Messages', 'Modules', 'Tables'];
  if (required.some(function (name) {
    return !(admin !== null && admin !== void 0 && admin[name]);
  })) {
