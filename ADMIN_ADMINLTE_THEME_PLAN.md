...
- Точка возобновления: обновить PHPDoc/public interfaces и generator stubs, затем отдельно доказать установку готового Composer artifact в чистое Laravel-приложение без Node.js.
